...
" Genshi Stuff
syn match kidAttr '\<py:choose\>' containedin=htmlTag contained nextgroup=kidPythonAttr
syn match kidAttr '\<py:when\>' containedin=htmlTag contained nextgroup=kidPythonAttr
syn match kidAttr '\<py:otherwise\>' containedin=htmlTag contained nextgroup=kidPythonAttr
syn match kidAttr '\<py:with\>' containedin=htmlTag contained nextgroup=kidPythonAttr
"syn match kidAttr '\<py:\>' containedin=htmlTag contained nextgroup=kidPythonAttr
